...
import './App.css';
import { Component } from 'react'; //import React from 'react'; mesma coisa
...
/* 
componentDidMount() { -> é executado só uma vez, disparar uma renderização extra

}

componentDidUpdate() { é invocado imediatemente após alguma atualização ocorrer. Este metodo não é chamado pelo initial render()
